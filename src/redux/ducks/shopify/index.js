...
// Example Storefront
const client = Client.buildClient({
  storefrontAccessToken: "cfd4ae6aa61baec64b5e300236b49606",
  domain: "sexes-by-stephanie.myshopify.com",
});
...
function addToCart(checkoutId, lineItemsToAdd) {
  return async (dispatch) => {
...
export function useShopify() {
  ...
  const addVariant = (checkoutId, lineItemsToAdd) =>
    dispatch(addToCart(checkoutId, lineItemsToAdd));
